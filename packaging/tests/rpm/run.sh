...
# Parameterized runner for RPM integration tests.
# Usage: run.sh <distro> <lang>
# Example: ARCH=amd64 ./run.sh fedora-41 java
...
echo "Running package integration tests for ${lang}/rpm/${distro}/${arch}."

SCRIPT_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )"
cd "$SCRIPT_DIR/../../.."

dockerfile="packaging/tests/rpm/${distro}/${lang}/Dockerfile"
