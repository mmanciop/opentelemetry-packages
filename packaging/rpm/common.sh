...
PKG_URL="https://github.com/mmanciop/opentelemetry-packages"
...
setup_java_buildroot() {
    ...
    local doc_dir="${buildroot}${DOC_DIR}/opentelemetry-java-autoinstrumentation"
    mkdir -p "$doc_dir"
...
setup_nodejs_buildroot() {
    ...
    local doc_dir="${buildroot}${DOC_DIR}/opentelemetry-nodejs-autoinstrumentation"
    mkdir -p "$doc_dir"
...
setup_dotnet_buildroot() {
    ...
    local doc_dir="${buildroot}${DOC_DIR}/opentelemetry-dotnet-autoinstrumentation"
    mkdir -p "$doc_dir"
